...
languages["MDX"] = require("mdx")
languages["MMIXAL"] = require("mmixal")
languages["Nim"] = require("nim")
...
languages["Terraform"] = require("terraform")
languages["TOML"] = require("toml")
...
languages["Svelte"] = require("svelte")
languages["Zig"] = require("zig")
